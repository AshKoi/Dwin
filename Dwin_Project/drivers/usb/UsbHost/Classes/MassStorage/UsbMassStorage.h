...
boolean_t MassStorageDeinitHandler(void);
boolean_t MassStorageInitHandler(uint8_t* pu8Configuration, uint32_t u32Length);
void UsbMassStorage_BulkInCompletion(void);
void UsbMassStorage_BulkOutCompletion(void);
...
StorageInfo_t* UsbMassStorage_GetGlobalStorageInfo(void);
