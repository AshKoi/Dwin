...
/*!
 ******************************************************************************
 ** \brief Ethernet MAC Registers bits definitions.
 **
 **
 **
 ******************************************************************************
...
/*!
 ******************************************************************************
 ** \brief Ethernet PTP Registers bits definition .
 **
 **
 **
 ******************************************************************************
...
/*!
 ******************************************************************************
 ** \brief Ethernet DMA Registers bits definition.
 **
 **
 **
 ******************************************************************************
...
#define EMAC_MAX_PACKET_SIZE   1520//1520    /* EMAC_HEADER + EMAC_EXTRA + MAX_EMAC_PAYLOAD + EMAC_CRC */
...
/*!
 ******************************************************************************
 ** \brief Ethernet DMA int registers bits definition.
 **
 ******************************************************************************
 */
...
#define PHY_ADDRESS                      0           /* PHY address index based on the hardware topology*/
...
//
#define PHY_SR                           16    /* The PHY status register value of DP83848*/
//
...
#define EMAC_DMA_INT_TST       ((uint32_t)0x20000000)  /* Time-stamp trigger interrupt (on DMA) */
#define EMAC_DMA_INT_PMT       ((uint32_t)0x10000000)  /* PMT interrupt (on DMA) */
#define EMAC_DMA_INT_MMC       ((uint32_t)0x08000000)  /* MMC interrupt (on DMA) */
#define EMAC_DMA_INT_NIS       ((uint32_t)0x00010000)  /* Normal interrupt summary */
#define EMAC_DMA_INT_AIS       ((uint32_t)0x00008000)  /* Abnormal interrupt summary */
