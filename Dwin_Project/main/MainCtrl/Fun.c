...
const COM_CFG	g_sComCfg[] = {
    ...
    {COMM_WH232,			UART_BPS_115200,	EVEN_PARITY, ONE_STOP_BIT, EIGHT_CHAR_BIT},
    {COMM_ZB,			    UART_BPS_2400,		EVEN_PARITY, 	 ONE_STOP_BIT, EIGHT_CHAR_BIT},
    {COMM_GPRS,			    UART_BPS_115200,	NO_PARITY,   ONE_STOP_BIT, EIGHT_CHAR_BIT},
    {COMM_WH485,			UART_BPS_2400,	EVEN_PARITY, ONE_STOP_BIT, EIGHT_CHAR_BIT},
    {COMM_ERR,			    UART_BPS_9600,		EVEN_PARITY, ONE_STOP_BIT, EIGHT_CHAR_BIT},
