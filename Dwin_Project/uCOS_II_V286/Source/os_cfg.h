...
#define OS_LOWEST_PRIO           64//32    /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            100    /* Max. number of event control blocks in your application      (64*2)-100*/
#define OS_MAX_FLAGS             16    /* Max. number of Event Flag Groups    in your application      (64*2)-16*/
#define OS_MAX_MEM_PART          5    /* Max. number of memory partitions                             (64)-5*/
#define OS_MAX_QS                5    /* Max. number of queue control blocks in your application      (64)-5*/
#define OS_MAX_TASKS             32//20    /* Max. number of tasks in your application, MUST be >= 2       */
